...
For complete access to datacubes, the SIA-2.0 specification  makes use of features defined in DataLink \citep{std:DataLink}. It also makes use of AccessData services such as SODA, as well as custom data services.
...
Below are some of the more common use cases that have motivated the development of the DsSAP specification. While this is not complete, it helps to understand the problem area covered by this specification.
